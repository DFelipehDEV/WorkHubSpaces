          ...
          <div className="p-8">
            <div className="flex justify-between items-start mb-6">
              ...
              <div className="text-right">
                <p className="text-xl font-bold text-stone-800">{space.pricePerHour}€/{t('space.hour')}</p>
                <p className='text-xl font-bold text-stone-800'>{space.pricePerHour * 24}€/{t('space.day')}</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 border-t border-stone-100 pt-6">
              ...
              <div className="space-y-6 rounded-md">
                <div className='flex justify-end'>
                  <button className="bg-primary-2 text-white rounded-md px-3 py-2 cursor-pointer">{t('space.book')}</button>
                </div>
                <div>
                  <div className='flex md:gap-2'>
                    <Package/>
                    <h3 className="font-semibold text-stone-800 mb-1">{t('space.equipments')}</h3>
                  </div>
                  {space.equipments && space.equipments.length > 0 ? (
                    ...
                    <p className="text-stone-500 text-sm">{t('space.no_equipments')}</p>
                  )}
                </div>
              </div>
            </div>
