...
function Profile() {
  ...
  return (
    <div style={{ padding: '40px 20px', maxWidth: '500px', margin: '0 auto', width: '100%' }}>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
            ...
            <input
              ...
              disabled
              className="font-sans"
              style={{ padding: '8px', border: '1px solid #eeeeee', borderRadius: '4px', fontSize: '14px', backgroundColor: '#f9f9f9', color: '#888888', outline: 'none' }}
            />
          </div>
